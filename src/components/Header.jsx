//modeled after MinneGrowta header.jsx 
        ...
        <Navbar bg="dark" variant="dark" expand="sm">
          <Container fluid>
            ...
            <Navbar.Brand className="me-auto" href="/">
              ...
              /> */}
              <h1>
                <span className="dot" id="red">THE</span>
                <span className="dot" id="yellow">ONE</span>
                <span className="dot" id="blue">WHERE</span>
                <span className="dot" id="red">DANIKA</span>
                <span className="dot" id="yellow">GRADUATES</span>
                <span className="dot" id="yellow"></span>
              </h1>
                <br/>
               <h1>
                <span class="dot" id="red"></span> CLASS
                <span class="dot" id="yellow"></span> OF
                <span class="dot" id="blue"></span> 2024
